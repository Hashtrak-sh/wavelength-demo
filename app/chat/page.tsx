...
export default function ChatPage() {
  ...
  const renderSummaryMessage = (message: Message, index: number) => {
        ...
        <div key={index} className="flex items-start space-x-4 mb-6 justify-start">
          ...
          <div className="relative max-w-[80%] rounded-2xl px-4 py-3 bg-gray-800 text-white">
            ...
            <div className="border-t border-gray-600 pt-4">
              <p className="mb-3 font-medium">Would you like to provide WhatsApp number?</p>
      ...
      return (
        <div key={index} className="flex items-start space-x-4 mb-6 justify-start">
          ...
          <div className="relative max-w-[80%] rounded-2xl px-4 py-3 bg-gray-800 text-white">
            ...
            <div className="border-t border-gray-600 pt-4">
              <p className="mb-3 font-medium">Please enter your WhatsApp number:</p>
      ...
      return (
        <div key={index} className="flex items-start space-x-4 mb-6 justify-start">
          ...
          <div className="relative max-w-[80%] rounded-2xl px-4 py-3 bg-gray-800 text-white">
            ...
            <div className="border-t border-gray-600 pt-4">
              <p className="mb-3 font-medium">Would you like to continue chatting?</p>
              <button
    ...
    // Default summary message display (completed state or initial)
    return (
      <div key={index} className="flex items-start space-x-4 mb-6 justify-start">
        <div className="w-8 h-8 rounded-full bg-white flex-shrink-0 flex items-center justify-center">
          <span className="text-black text-sm">wL</span>
          ...
          <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
            <div className="relative flex items-center bg-gray-800 rounded-xl">
              <textarea
                ...
                style={{ height: '44px' }}
                rows={1}
                disabled={isLoading || Boolean(whatsappFlowState && whatsappFlowState !== 'completed')}
              />
              <div className="absolute right-3 flex items-center h-full">
                <button
                  type="submit"
                  disabled={isLoading || !input.trim() || Boolean(whatsappFlowState && whatsappFlowState !== 'completed')}
